document.addEventListener("DOMContentLoaded", () => {
    ...
    // ⚡ Bolt Optimization: Use triggerUpdateDebounced instead of synchronous updateQR
    // for continuous color input events to prevent UI freezing and main thread blocking.
    // Expected impact: smoother color picking experience without stuttering.
    ...
    // ⚡ Bolt Optimization: Debounce range slider inputs to prevent main thread blocking
    ...
    logoSize.addEventListener("input", (e) => {
        ...
        // ⚡ Bolt Optimization: Debounce continuous range slider input
        triggerUpdateDebounced();
    });
